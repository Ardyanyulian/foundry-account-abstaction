...
contract ZkMinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    // Fungsi diatas itu menyebabkan error stack too deep 
    
    /** 
     Deep Error  
        - Tempat penyimpanan sementara yakni Stack itu untuk menyimpan operasi aritmatika dan 
          penyimpanan data sementara.
        - Maksimal deepnya itu 1042 slot saja
        - bahasa tingkat rendah misal:  Yul/Assembly itu punya batas slot
          yang dapat ditukar(swap) atau duplikat
        - Ini terjadi bila (misal) : variabel yang aku coba operasikan itu berada
          dibawah dari 16 slot dari slot teratas.
        - 
    */
